...
// If you have a custom Button component, keep this import. Otherwise, use a regular <button> or <a>.
        ...
        >
          <HighlighterItem className="rounded-3xl p-6">
            <div className="relative z-20 h-full overflow-hidden rounded-3xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-black">
              <Particles
                className="absolute inset-0 -z-10 opacity-100 transition-opacity duration-1000 ease-in-out"
                quantity={200}
                color={"#555555"}
                vy={-0.2}
              />
                  ...
                  <div className="-mt-20 flex h-full flex-col justify-center p-2 md:-mt-4 md:ml-10 md:w-[400px]">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <a
                        ...
                        className={cn(
                          // If you have buttonVariants, use it. Otherwise, use your own classes.
                          "inline-flex items-center justify-center rounded-md bg-emerald-600 px-4 py-2 text-white hover:bg-emerald-700 transition"
                        )}
                      >
                        Book a call
                      </a>
                      <a
                        ...
                        rel="noopener noreferrer"
                        className={cn(
                          "inline-flex items-center justify-center rounded-md border border-emerald-600 px-4 py-2 text-emerald-700 hover:bg-emerald-50 transition"
                        )}
                      >
                        <span className="flex items-center gap-1 h-4 w-4">
                          <img src="https://cdn.simpleicons.org/gmail/gmail" />
                        </span>
                      </a>
                      <a
